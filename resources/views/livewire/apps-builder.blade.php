<div>
    <div class="container form_header">
        <div class="headerWrap" style="display: flex ; align-items: center;justify-content: space-between;">
            <div  class="flexItem">
                <h4>
                      Application Builder (v1.0)
                </h4>
              
            </div>
           <div  class="flexItem middleItem">
                <h4 class="m-2" style="color:rgb(20, 220, 53)">
                    Validate State :  {{ $validateState }}                   
                </h4>
           </div> 

            <div  class="flexItem lastItem">
        ...
        @foreach ($colArr as $k => $val)
                ...
                @if ($type == 'start' || $type == 'oneRow')
                    ...
                    <div class="{{ $opts['bf'] }}">
                        ...
                        {{-- <div --}}
                        <div class="row"
                            style="margin-bottom:10px; margin-left:1px;direction:rtl; border-radius:10px;background-color:rgb(238, 237, 237);border:2px solid rgb(184, 182, 182);direction: rtl">
