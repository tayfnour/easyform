<div>
    ...
    <div class="container-fluid"  >{{-- start second container --}}
        ...
        <div class="row" style="direction: rtl;border-radius:10px ;background-color:wheat">      
            ...
            @endphp
               ...
               @if ($fopts["isOpen"] == 1)
                        ...
                        @if ($type == 'start' || $type == 'oneRow')
                            ...
                            <div class="col-{{isset($opts["formColsCount"])?$opts["formColsCount"]:"12"}} form-container" >{{--column : start container of Form --}} 
                            
                                <div class="row p-1"> {{-- row : start Row of Form --}}
                                
                                <div class="col-12 form-bg" style="border-radius:8px">{{-- column : start container of Form --}}
                                ...
                                <div class="row"> {{--body row--}}
                                    <div class="col-12 form-body pb-2">
                                        <div class="row reapeted-row">
                                            ...
                                            @endif     
                                            {{--Row Area--}}                               
                                            <div class="col-{{isset($opts["bodyColsCount"])?$opts["bodyColsCount"]:"12"}} p-1">
                                                   ...
                                                   @foreach ($opts['cols'] as $col)
                                                        ...
                                                        @if ($opts[$col]['inputType'] == 'button')
                                                            <div class='text-end {{ $opts[$col]['bootstrap'] }}'>
                                                                ...
                                                                @endif
                                                                <button wire:click='{{$opts[$col]['onEventFn'] }}({{ $k }})'
                                                                    class='btn btn-twitter'>{{$colArr[$k][$col]}}</button>
                                                            </div>
                                                        @endif
