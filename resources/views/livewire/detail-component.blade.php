            ...
            <div class="col-lg-9 col-md-8 col-sm-8 col-xs-12 main-content-area">
                <div class="wrap-product-detail">
                    <div class="detail-media">
                        <div class="product-gallery">
                          <ul class="slides">
                            ...
                            <li data-thumb="http://localhost/easyPanel/storage/app/public/{{$product->image}}">
                                <img src="http://localhost/easyPanel/storage/app/public/{{$product->image}}" alt="product thumbnail" />
                            </li>
                    ...
                    <div class="detail-info">
                        ...
                        <h2 class="product-name">{{ $product->pro_name }} [White]</h2>
                        ...
                        <div class="wrap-butons">
                            <a href="#" class="btn add-to-cart" wire:click.prevent="store({{$product->id}} ,'{{$product->pro_name}}',{{$product->price}})" >Add to Cart</a>
                            <div class="wrap-btn">
