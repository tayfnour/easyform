...
<head>
    ...
    @style("/assets/admin/css/myStyle.css")
    ...
    <header class="topbar" data-navbarbg="skin6">
        <nav class="navbar top-navbar navbar-expand-md">
            ...
            <div class="navbar-collapse collapse" id="navbarSupportedContent">
                ...
                <li>
                    <div class="tog_left" onclick="myFunction(this)">
                        <div class="bar1"></div>
                        <div class="bar2"></div>
                        <div class="bar3"></div>
                    </div>
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle pl-md-3 position-relative" href="javascript:void(0)"
                               ...
                               aria-expanded="false">
                                ...
                                {{ \EasyPanel\Models\Todo::where('user_id', auth()->user()->id)->where('checked', false)->count() }}</span>
                            </a>
...
@script("/assets/admin/js/myScript.js")
