...
use App\MyClass\purchasesManageExtend;
...
class PurchasesManagement extends Component
{
    ...
    public function mount($formAll = ['Create New Invoice Header', 'suppliers' ,'Create New Invoice Body', 'operations', 'p_entryheads', 'p_entries', 'trialbalances', 'Create New Product'])
    {
 ...
 //   dd($this->colArr[$row_id]);
    ...
    {
        return view('livewire.purchases-management'  , ['bs_arrows' => $this->arrows]);
    }
}
