...
class MultipleFormWidget extends Component
{
    ...
    public function init()
    {
        ...
        foreach ($res as $k => $v) {
            ...
            $this->fOpts[$v->proForm] = ["isClose"=>$v->isClose , "isFloat"=>$v->isFloat   , "description"=>$v->description ];
        }
    ...
    public function formsLoop()
    {
        ...
        foreach ($this->forms as $form) {
            ...
            if ($action == 'getParentRefrence') {               
                ...
                if (isset($opts["sourceQuery"]) && $opts["sourceQuery"]="multipleForm"){   
 ...
 //   dd($this->colArr[$row_id]);
    ...
    public function excuteFuncAfterEveryRow($row_id, $action=null){
    ...
    public function render()
    {
        ...
        return view('livewire.multiple-form-widget'  , ['bs_arrows' => $this->arrows]);
    }
}
