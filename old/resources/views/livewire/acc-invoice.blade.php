<div>
    <div class="container form_header">
        <div>
            <h4 class="m-2" style="color:rgb(20, 220, 53)"> Validate State :
                {{ $validateState }}
        ...
        @foreach ($colArr as $k => $val)
                ...
                @if ($type == 'start' || $type == 'oneRow')
                    ...
                    <div class="{{ $opts['bf'] }}">
                        ...
                        {{-- <div --}}
                        <div class="row"
                            style="margin-bottom:10px; direction:rtl; border-radius:8px;background-color:rgb(238, 237, 237);border:1px solid rgb(184, 182, 182);direction: rtl">
                ...
                <div class="row p-2">
                    ...
                    @foreach ($opts['cols'] as $col)
                        ...
                        @if ($opts[$col]['inputType'] == 'button')
                            <div class='text-end {{ $opts[$col]['bootstrap'] }}'>
                                ...
                                <label class='p-2' style="font-size: 15px">&nbsp;</label>
                                @endif
                                <input wire:click='{{$opts[$col]['onEventFn']}}({{ $k }})' type='button' value='{{ $opts[$col]['arabic_name'] }}' class='btn btn-secondary' >                          
                            </div>
                        @endif
                            ...
                            <div class='{{ $opts[$col]['bootstrap'] }}'>
                                <div style="position: relative">
                                    ...
                                    <input
                                        ...
                                        {{-- {{ $this->buildEvents($opts[$col]['onEventFn']) }} --}} class='form-control{{ $opts[$col]['widget'] }}'
                                        style='padding-left:25px;font-size:16px'>
                    ...
                    {{--delete button afterb every form --}}
               ...
               @endif 
                ...
                <hr  style="border:1px solid rgb(136, 136, 136); margin-bottom:2px">
                @endif

                {{-- {!! $this->getActionButtons($opts[$pk]['formType'], $k, $opts[$pk]['logicalVal']) !!} --}}
