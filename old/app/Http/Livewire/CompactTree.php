...
class CompactTree extends Component
{
   ...
   // public  $filter = 41;
    ...
    protected $listeners = ['createTreeTable' => 'createTreeTable' , 'setTableofTree' => 'setTableofTree'];
    ...
    public function setTableofTree($lookup , $id){
        $this->tbName = $lookup;
        $this->dispatchBrowserEvent('moveTop', ['id'=>$id]);
    }
...
public function addNode($parent , $newNode ){
    ...
    function setGlobalVar( $code , $parent , $is_end , $list_order){   
       ...
       $this->emit("sendLeafValue" , $this->code);   
    ...
    public function render()
    {
        ...
        $tree = new Tree();    
        return view('livewire.compact-tree',
        [
